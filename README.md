...
**Mission**: The platform will enable users to input basic information about new YouTubers, such as video category, like-dislike ratio and views per subscriber, and predict the future subscribers of the input YouTuber based on data of mature YouTube channels. The model will find the most similar 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA5MDgxNDA0Myw1ODczMzA4OSwtOTYzMz
g4NTU0XX0=
-->