...
- Business criteria: 
  ...
  - Predicted number of subscribers for new user input channels are within a 5% error range of the actual subscriber numbers
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMwNDU3NjI0MywtNzA4OTMyOTE5LC0xMj
